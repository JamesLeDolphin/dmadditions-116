...
public class ItemInit {
    ...
    public static RegistryObject<Item> TARDIS_GOLD_KEY = RegistryHandler.ITEMS.register("tardis_gold_key", () -> new TardisKeyItem((new Item.Properties()).tab(DMTabs.DM_TARDIS), ""));
