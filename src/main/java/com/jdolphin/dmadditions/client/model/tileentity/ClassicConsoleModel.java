...
public class ClassicConsoleModel extends Model {
	...
	public void renderRotor(MatrixStack matrixStack, IVertexBuilder buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
