...
public class BetterChameleonPanelBlock extends ChameleonPanelBlock implements IHorizontalFaceBlock, IBlockTooltip {
	...
	protected static final VoxelShape UP_AABB = Block.box(0.0D, 0.0D, 0.0D, 16.0D, 3.0D, 16.0D);
