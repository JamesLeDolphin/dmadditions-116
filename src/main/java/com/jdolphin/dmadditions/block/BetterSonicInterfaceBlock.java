...
//		System.out.printf("x: %s, z: %s%n", mouseX, mouseZ);
		...
		return new TranslationTextComponent(String.format("tooltip.block.%s.%s.%s", resourceLocation.getNamespace(), resourceLocation.getPath(), txt));
	}
