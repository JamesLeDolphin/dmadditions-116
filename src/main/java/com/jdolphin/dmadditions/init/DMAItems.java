...
public class DMAItems {
	...
	protected static RegistryObject<Item> registerAdventItem(int day, String name, Supplier<Item> supplier) {
		...
		return RegistryHandler.DMARegistries.ITEMS.register(name, supplier);
	}
	...
	public static RegistryObject<Item> GREEN_CANDY_CANE = RegistryHandler.DMARegistries.ITEMS.register("green_candy_cane",
			() -> new FoodItem((new Item.Properties()).food(DMAFoods.CANDY_CANE).tab(ItemGroup.TAB_FOOD)));

	public static RegistryObject<Item> ORANGE_CANDY_CANE = RegistryHandler.DMARegistries.ITEMS.register("orange_candy_cane",
			() -> new FoodItem((new Item.Properties()).food(DMAFoods.CANDY_CANE).tab(ItemGroup.TAB_FOOD)));

	public static RegistryObject<Item> PURPLE_CANDY_CANE = RegistryHandler.DMARegistries.ITEMS.register("purple_candy_cane",

			() -> new FoodItem((new Item.Properties()).food(DMAFoods.CANDY_CANE).tab(ItemGroup.TAB_FOOD)));
	public static RegistryObject<Item> PINK_CANDY_CANE = RegistryHandler.DMARegistries.ITEMS.register("pink_candy_cane",

			() -> new FoodItem((new Item.Properties()).food(DMAFoods.CANDY_CANE).tab(ItemGroup.TAB_FOOD)));
	public static RegistryObject<Item> YELLOW_CANDY_CANE = RegistryHandler.DMARegistries.ITEMS.register("yellow_candy_cane",
			() -> new FoodItem((new Item.Properties()).food(DMAFoods.CANDY_CANE).tab(ItemGroup.TAB_FOOD)));


	public static RegistryObject<Item> SNOWMAN_SPAWNER = addSpawnItem("snowman");

	public static RegistryObject<Item> UNIT_GUN = RegistryHandler.DMARegistries.ITEMS.register("unit_gun",
	...
	public static RegistryObject<Item> TORCHWOOD_PISTOL = RegistryHandler.DMARegistries.ITEMS.register("torchwood_pistol",
	...
	public static RegistryObject<Item> SANTA_HAT = RegistryHandler.DMARegistries.ITEMS.register("santa_hat",
	...
	public static RegistryObject<Item> SPACE_SUIT_HELMET = RegistryHandler.DMARegistries.ITEMS.register("space_suit_helmet",
			() -> new ArmorItem(DMAArmorMaterial.SPACE_SUIT, EquipmentSlotType.HEAD, new Item.Properties()));

	public static RegistryObject<Item> SPACE_SUIT_CHESTPLATE = RegistryHandler.DMARegistries.ITEMS.register("space_suit_chestplate",
			() -> new ArmorItem(DMAArmorMaterial.SPACE_SUIT, EquipmentSlotType.CHEST, new Item.Properties()));

	public static RegistryObject<Item> SPACE_SUIT_LEGGINGS = RegistryHandler.DMARegistries.ITEMS.register("space_suit_leggings",
			() -> new ArmorItem(DMAArmorMaterial.SPACE_SUIT, EquipmentSlotType.LEGS, new Item.Properties()));

	public static RegistryObject<Item> SPACE_SUIT_BOOTS = RegistryHandler.DMARegistries.ITEMS.register("space_suit_boots",
			() -> new ArmorItem(DMAArmorMaterial.SPACE_SUIT, EquipmentSlotType.FEET, new Item.Properties()));


	public static RegistryObject<Item> LASER_SCREWDRIVER = RegistryHandler.DMARegistries.ITEMS.register("laser_screwdriver",
			() -> new LaserScrewdriverItem(ItemGroup.TAB_TOOLS, 100, DMAProjectiles.METALLIC_GOLD_LASER));

	public static RegistryObject<Item> MUSIC_DISC_PFD = RegistryHandler.DMARegistries.ITEMS.register("music_disc_pfd",
		...
		public static RegistryObject<Item> PILOT_FISH_TRUMPET = RegistryHandler.DMARegistries.ITEMS.register("pilot_fish_trumpet",
	...
	public static RegistryObject<Item> PISTOL = RegistryHandler.DMARegistries.ITEMS.register("pistol", ()
	...
	public static RegistryObject<Item> DINO_NUGGETS_CUSTARD = RegistryHandler.DMARegistries.ITEMS.register("dino_nuggets_custard",
	...
	public static <T extends Entity> RegistryObject<Item> addSpawnItem(String key, String type) {
		RegistryObject<Item> item = RegistryHandler.DMARegistries.ITEMS.register(type + "_spawner", () -> {
