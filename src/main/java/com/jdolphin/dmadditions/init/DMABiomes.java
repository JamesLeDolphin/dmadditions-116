...
public class DMABiomes {
	...
	public static RegistryKey<Biome> GALLIFREY;
	public static final RegistryObject<Biome> GALIFREY_PLAINS = BIOMES.register("gallifrey_plains", BiomeMaker::theVoidBiome);
	public static final RegistryObject<Biome> GALIFREY_DESERT = BIOMES.register("gallifrey_desert", BiomeMaker::theVoidBiome);
	public static final RegistryObject<Biome> GALIFREY_MOUNTAINS = BIOMES.register("gallifrey_mountains", BiomeMaker::theVoidBiome);
	public static final RegistryObject<Biome> GALIFREY_FOREST = BIOMES.register("gallifrey_forest", BiomeMaker::theVoidBiome);
