...
public class DMABlocks {
	...
	public static RegistryObject<Block> GALLIFREY_COBBLE_STONE = registerBlockAndItem("gallifrey_cobble_stone", () -> new Block(AbstractBlock.Properties.copy(Blocks.COBBLESTONE)),
		new Item.Properties().tab(ItemGroup.TAB_BUILDING_BLOCKS));
