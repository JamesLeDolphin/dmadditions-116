...
public class DMAEntities {
	...
	public static final RegistryObject<EntityType<JamesLeDolphinEntity>> JAMESLEDOLPHIN = DMARegistries.ENTITY_TYPES.register("jamesledolphin",
	...
	public static RegistryObject<EntityType<PilotFishEntity>> PILOT_FISH = DMARegistries.ENTITY_TYPES.register("pilot_fish",
	...
	public static RegistryObject<EntityType<SnowmanEntity>> SNOWMAN = DMARegistries.ENTITY_TYPES.register("snowman",
	...
	public static RegistryObject<EntityType<ChristmasTreeEntity>> CHRISTMAS_TREE = DMARegistries.ENTITY_TYPES.register("christmas_tree",
	...
	public static RegistryObject<EntityType<WoodenCybermanEntity>> WOODEN_CYBERMAN = DMARegistries.ENTITY_TYPES.register("wooden_cyberman",
	...
	public static RegistryObject<EntityType<BessieEntity>> BESSIE = DMARegistries.ENTITY_TYPES.register("bessie",
	...
	public static RegistryObject<EntityType<TorchwoodSuvEntity>> TW_SUV = DMARegistries.ENTITY_TYPES.register("torchwood_suv",
