...
public class DMAEntities {
	...
	public static final RegistryObject<EntityType<JamesLeDolphinEntity>> JAMESLEDOLPHIN = RegistryHandler.ENTITY_TYPES.register("jamesledolphin",
	...
	public static RegistryObject<EntityType<PilotFishEntity>> PILOT_FISH = RegistryHandler.ENTITY_TYPES.register("pilot_fish",
	...
	public static RegistryObject<EntityType<SnowmanEntity>> SNOWMAN = RegistryHandler.ENTITY_TYPES.register("snowman",
	...
	public static RegistryObject<EntityType<ChristmasTreeEntity>> CHRISTMAS_TREE = RegistryHandler.ENTITY_TYPES.register("christmas_tree",
	...
	public static RegistryObject<EntityType<WoodenCybermanEntity>> WOODEN_CYBERMAN = RegistryHandler.ENTITY_TYPES.register("wooden_cyberman",
	...
	public static RegistryObject<EntityType<BessieEntity>> BESSIE = RegistryHandler.ENTITY_TYPES.register("bessie",
	...
	public static RegistryObject<EntityType<TorchwoodSuvEntity>> TW_SUV = RegistryHandler.ENTITY_TYPES.register("torchwood_suv",
