...
public class DMAEntities {
	...
	static {
		...
		PILOT_FISH = DMARegistries.ENTITY_TYPES.register("pilot_fish",
		...
		SNOWMAN = DMARegistries.ENTITY_TYPES.register("snowman",
		...
		CHRISTMAS_TREE = DMARegistries.ENTITY_TYPES.register("christmas_tree",
		...
		WOODEN_CYBERMAN = DMARegistries.ENTITY_TYPES.register("wooden_cyberman",
