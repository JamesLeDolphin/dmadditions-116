...
public class GallifreyShedStructure extends Structure<NoFeatureConfig> {
	...
	private static final List<MobSpawnInfo.Spawners> STRUCTURE_CREATURES = ImmutableList.of(new MobSpawnInfo.Spawners(DMAEntities.TIMELORD.get(),
		1, 0, 2));

	public GallifreyShedStructure(Codec<NoFeatureConfig> codec) {
		super(codec);
	}

	public IStartFactory<NoFeatureConfig> getStartFactory() {
		return GallifreyShedStructure.Start::new;
	}
