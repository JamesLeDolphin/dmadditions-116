...
import com.jdolphin.dmadditions.common.tileentity.*;
...
public class DMABlockEntities {
	...
	public static final RegistryObject<TileEntityType<JavaJsonModelLoaderTileEntity>> JAVAJSON_MODEL_LOADER = TILE_ENTITY_TYPES.register("javajson_model_loader",
		() -> TileEntityType.Builder.of(JavaJsonModelLoaderTileEntity::new, DMABlocks.DOOR_PANEL.get()).build(null));

	public static final RegistryObject<TileEntityType<ClassicConsoleTileEntity>> CLASSIC_CONSOLE = TILE_ENTITY_TYPES.register("classic_console",
		() -> TileEntityType.Builder.of(ClassicConsoleTileEntity::new, DMABlocks.CLASSIC_CONSOLE.get()).build(null));
