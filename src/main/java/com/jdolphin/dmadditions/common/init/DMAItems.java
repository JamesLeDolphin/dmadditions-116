...
import com.jdolphin.dmadditions.common.item.*;
...
public class DMAItems {
	...
	public static RegistryObject<Item> TARDIS_LOCKPICK = ITEMS.register("tardis_lockpick",
		() -> new Item(new Item.Properties().tab(ItemGroup.TAB_MISC).durability(16)));
