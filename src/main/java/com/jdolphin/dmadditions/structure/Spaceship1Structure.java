...
public class Spaceship1Structure {
	...
	public Structure.IStartFactory<NoFeatureConfig> getStartFactory() {
		return Spaceship1Structure.Start::new;
	}
	...
	public static class Start extends StructureStart<NoFeatureConfig> {
		...
		public void generatePieces(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn, NoFeatureConfig config) {
			...
			JigsawManager.addPieces(dynamicRegistryManager, new VillageConfig(() -> {
				return dynamicRegistryManager.registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY).get(new ResourceLocation("dmadditions", "spaceship_1/start_pool"));
